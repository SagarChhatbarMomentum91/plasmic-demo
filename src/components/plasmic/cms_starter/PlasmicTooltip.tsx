...
import sty from "./PlasmicTooltip.module.css"; // plasmic-import: w27VTSsp4KQv/css
...
function PlasmicTooltip__RenderFunc(props: {
  ...
  return (
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <div
                    className={classNames("all", "__wab_text", sty.text__wCxbO)}
                  >
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", "__wab_text", sty.text___26WqB)}>
            {"Hover me!"}
          </div>
        ),
        value: args.trigger,
