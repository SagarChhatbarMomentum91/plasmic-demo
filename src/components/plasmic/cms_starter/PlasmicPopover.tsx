...
import Button from "../../Button"; // plasmic-import: JEf1ip1oAwi6/component
import { BasePopover } from "@plasmicpkgs/react-aria/skinny/registerPopover";
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: J-OlJIV_bk6J/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: PZlUPnQj7TpT/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox___2Doo)}>
                  <div
                    className={classNames("all", "__wab_text", sty.text__b1ZBf)}
                  >
                    {"This is a Popover!"}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__evaSj)}
                  >
                    {"You can put anything here!"}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__pzVfr)}
                  >
                    {
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button___1Pcq1)}
            label={"Open Popover"}
          />
        ),
