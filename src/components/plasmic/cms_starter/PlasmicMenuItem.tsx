...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: M-9TTdm_35ff/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__exw6E)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames("all", sty.freeBox__qB2Ra)}>
            <div className={classNames("all", "__wab_text", sty.text__nuCxN)}>
              <React.Fragment>
                {(() => {
                  try {
                    return $props.label;
        ...
        {(() => {
          ...
          <BaseText2
            ...
            slot={"description"}
          >
            <div className={classNames("all", "__wab_text", sty.text__vuMcY)}>
