...
import SliderThumb from "../../SliderThumb"; // plasmic-import: NRk44LjyhVVT/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: 2IMe7TmoAa3L/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__yWlEh)}>
        {$props.showLabel ? (
          <Label
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames("all", "__wab_text", sty.text__lxirc)}
                >
                  {"Label"}
                </div>
              ),
      ...
      <div className={classNames("all", sty.freeBox__xNpaV)}>
        <div
