...
import sty from "./PlasmicButton.module.css"; // plasmic-import: JEf1ip1oAwi6/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: v-EM5RL_Ssrs/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: HBJzPpmH2ztP/icon
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__bw4L, {
          [sty.freeBoxcolor_neutral__bw4LsmbT8]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__bw4L04Ywq]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__bw4Lf6U3J]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__bw4L9PfUs]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__bw4LQ2KDa]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__bw4LpOru1]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__bw4L4Cs6]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__bw4L4Cs6YgHno]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames("all", sty.freeBox___3Skzw, {
            [sty.freeBoxcolor_neutral___3SkzWsmbT8]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart___3SkzWnev6A]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___3SkzWf6U3J]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___3Skzwq2KDa]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___3SkzWpOru1]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___3Skzw4Cs6]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral___3Skzw0ShIqSmbT8]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__iFtWb)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__n19GR)}>
              {"Text"}
            </div>
          ),
          value: args.label,
        ...
        <div
          className={classNames("all", sty.freeBox__d2Hmj, {
            [sty.freeBoxiconEnd__d2HmjROSb]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__d2Hmjf6U3J]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__d2HmjQ2KDa]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__d2HmjpOru1]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg__qiVA)}
                role={"img"}
              />
            ),
