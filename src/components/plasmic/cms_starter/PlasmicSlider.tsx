...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: _iOWFEs6QI5P/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames("all", sty.freeBox__raUxj)}>
          {$props.showLabel ? (
            <Label
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames("all", "__wab_text", sty.text__itTrA)}
                  >
                    {"Label"}
                  </div>
                ),
      ...
      <div className={classNames("all", sty.freeBox__nMmXt)}>
        <div
