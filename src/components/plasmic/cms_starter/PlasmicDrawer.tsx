...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: UYupcEtsL-u7/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_G4AnIRdtEusT"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames("all", sty.freeBox__vBtR1)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox__pz4Rw)}>
                      <div
                        className={classNames(
                          "all",
                          "__wab_text",
              ...
              <div className={classNames("all", sty.freeBox__cmd4P)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox__v5Nn2)}>
                      <Button
                        color={"muted"}
                        label={"Close"}
                        onClick={async event => {
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__dmCzB)}
                  label={
                    <div
                      className={classNames(
                        "all",
