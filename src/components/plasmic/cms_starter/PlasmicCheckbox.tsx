...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: sLnbm2Q4cWOH/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: vlVtPo42aVIF/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: b9gdPvrBcYHc/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames("all", sty.svg___6Myfc)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames("all", sty.svg__al6Oc)}
            role={"img"}
          />
        ) : null}
      </div>
