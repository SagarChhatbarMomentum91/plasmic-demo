...
import Label from "../../Label"; // plasmic-import: suZc13pbJqH1/component
import TextInput from "../../TextInput"; // plasmic-import: a0VAF1K453vO/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: sFbTZ-YrCrjn/component
import Description from "../../Description"; // plasmic-import: EBqnJSto7PDo/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: jsvJKgQfy9Bc/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__rhhVn, {
          [sty.freeBoxiconEnd__rhhVnuTgw9]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__rhhVnl8XNt]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__rhhVnBvtLt]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox___2IMv, {
            [sty.freeBoxiconStart___2IMvl8XNt]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___2IMvBvtLt]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__l6Myv)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox__pEw56, {
            [sty.freeBoxiconEnd__pEw56UTgw9]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__pEw56L8XNt]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__zojrh)}
                role={"img"}
              />
            ),
