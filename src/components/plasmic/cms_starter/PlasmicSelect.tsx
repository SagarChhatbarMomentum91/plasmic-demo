...
import MenuPopover from "../../MenuPopover"; // plasmic-import: Rk416S5SKW0J/component
import MenuItem from "../../MenuItem"; // plasmic-import: M-9TTdm_35ff/component
import MenuSection from "../../MenuSection"; // plasmic-import: wdW9FBzizJy9/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: GxqbGviN_XJ7/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__hq93)}
                header={
                  <div
                    className={classNames("all", "__wab_text", sty.text__lpfCm)}
                  >
                    {"Section"}
                  </div>
                }
