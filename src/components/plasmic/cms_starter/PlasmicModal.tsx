...
import sty from "./PlasmicModal.module.css"; // plasmic-import: OcpA0rBc35Tr/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_d4Hz5NFaZNBw"]]: true })}
        ...
        >
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div className={classNames("all", sty.freeBox___3D3AC)}>
                    <div
                      className={classNames(
                        "all",
                        "__wab_text",
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox__vh16U)}>
                  <Button
                    color={"muted"}
                    label={
                      <div
