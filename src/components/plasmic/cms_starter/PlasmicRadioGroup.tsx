...
import Radio from "../../Radio"; // plasmic-import: YrNclXcHCcY0/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: DDncsTaAP6AI/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", sty.freeBox__poNg)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__hdl2O)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__bGgGq)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__bkr4Y)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
