...
import Checkbox from "../../Checkbox"; // plasmic-import: sLnbm2Q4cWOH/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: bSrWxOH0v4h_/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", sty.freeBox__jDaTc)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__kwunL)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__vAfM4)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___9CEoY)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
