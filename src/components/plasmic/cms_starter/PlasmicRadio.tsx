...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: YrNclXcHCcY0/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames("all", sty.freeBox__sgOXu)}>
        <div className={classNames("all", sty.freeBox__i3Ogl)} />
      </div>
      {renderPlasmicSlot({
